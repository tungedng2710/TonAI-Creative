...
- For SD 1.5 models, optimized size (w x h) is 768x768 (square), 512x864 (portrait), 864x512 (landscape). For SDXL and SD 3 models, optimized size (w x h) is 1024x1024 (square), 768x1152 (portrait), 1152x768 (landscape). You can read the [Resolution cheatsheat](https://www.reddit.com/r/StableDiffusion/comments/15c3rf6/sdxl_resolution_cheat_sheet/) to obtain more information.
